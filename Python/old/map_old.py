...
class BaseMap(QWidget):
    ...
    def add(self, filepath, dataset, plot_now = True):
        ...
        if plot_now:
            ...
            #     dataset.data[self.zaxis].min(),
            #     dataset.data[self.zaxis].max()
            # )

            # self.slider.setValues([
            #     dataset.data[self.zaxis].min(),
            #     dataset.data[self.zaxis].min()+0.33*(dataset.data[self.zaxis].max()-dataset.data[self.zaxis].min()),
            #     dataset.data[self.zaxis].min()+0.66*(dataset.data[self.zaxis].max()-dataset.data[self.zaxis].min()),
            #     dataset.data[self.zaxis].max(),
